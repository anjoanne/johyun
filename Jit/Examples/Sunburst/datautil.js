       ...
       }, 
       {
         "children": [
           ...
           }, 
           {
             "children": [], 
             "data": {
               "description": "의료서비스 데이터 시스템으로 환자의 의료기록이 저장. 의료서비스 공급자 간에 정보를 전달하는 중심적인 역할을 하며 환자들의 진료기록, 처방전 뿐만 아니라 영상검사 결과를 비롯한 모든 의료관련 정보가 시스템이 저장된다. 환자는 본인의 의료기록을 검색하여 이전에 진행되었던 처방전 기록을 확인해 볼수 있다.", 
               "$angularWidth": 12608, 
               "days": 15, 
               "$color": "#CABAD9", 
               "size": 12608
